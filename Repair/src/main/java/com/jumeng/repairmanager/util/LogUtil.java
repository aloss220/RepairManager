...
public class LogUtil {
	 ...
	 * @return 
	 */  
	public static LogUtil rLog()  
	{  
		if(rlog == null)  
		{  
			rlog = new LogUtil(RAIN);  
		}  
		return rlog;  
	}  
	...
	{   //返回一个代表该线程的堆栈转储堆栈跟踪元素的数组。如果该线程尚未启动或已经终止,返回一个零长度数组。
