...
public class ImageCycleView extends LinearLayout {
	 ...
	 */
	public void setImageResources(ArrayList<ADInfo> infoList, ImageCycleViewListener imageCycleViewListener,boolean flag) {
		// 清除所有子视图
		...
		mAdvAdapter = new ImageCycleAdapter(mContext, infoList, imageCycleViewListener,flag);
	...
	private class ImageCycleAdapter extends PagerAdapter {
		...
		public ImageCycleAdapter(Context context, ArrayList<ADInfo> adList,
				ImageCycleViewListener imageCycleViewListener,boolean flag) {
			mContext = context;
			mAdList = adList;
			mflag = flag;
		...
		public Object instantiateItem(ViewGroup container, final int position) {
			...
			int id = 0;
			if(mflag){
				imageUrl = mAdList.get(position).getUrl();
			}else{
				id = mAdList.get(position).getResID();
			}
	...
	public interface ImageCycleViewListener {
		 ...
		 * @param imageView
		 */
        void displayImageSD(int id, ImageView imageView);
